...
## Passo 2: Obter Sua Chave API do n8n

1. Faça login na sua instância n8n
2. Vá em **Settings** (ícone de engrenagem na barra lateral)
3. Clique em **API**
...
Substitua `SUA-INSTANCIA` pelo subdomínio do seu n8n cloud:
```
...
```
Quais skills do n8n você tem disponíveis?
```

O Claude deve listar as 8 skills do diretório `.claude/skills/`.

---

## Passo 5: Testar Conexão MCP
...
Se configurado corretamente, o Claude usará o MCP para listar os workflows da sua instância n8n.
...
1. Regenere a chave API em n8n Settings → API
2. Verifique se há espaços em branco na chave
3. Certifique-se de que a chave não expirou

### "Cannot connect to n8n"

1. Verifique se N8N_API_URL está correta
